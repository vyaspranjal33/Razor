...
namespace Microsoft.AspNetCore.Razor.Language
{
    public abstract class RazorSyntaxTree
    {
        ...
        public static RazorSyntaxTree Parse(RazorSourceDocument source, bool legacy = true)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        public static RazorSyntaxTree Parse(RazorSourceDocument source, RazorParserOptions options, bool legacy = true)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
